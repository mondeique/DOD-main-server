...
superadmin_register(PhoneConfirm, list_display=['phone', 'certification_number', 'is_confirmed', 'created_at'])
...
class PhoneConfirmAdmin(admin.ModelAdmin):
    list_display = ['phone', 'certification_number', 'is_confirmed', 'created_at']
