...
class Project(models.Model):
    name = models.CharField(max_length=30, default="설문추첨A")
    ...
    status = models.NullBooleanField(help_text="결제하기전에는 Null, staff 결제확인시 True : 무통장입금 결제 확인용") #Todo payment 붙으면 나중가서 힘내자
